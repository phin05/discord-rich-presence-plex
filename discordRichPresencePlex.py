...
#Code to add script to auto-start on Windows startup. THIS METHOD DOES NOT WORK FOR MACOS OR LINUX
#This code edits the registry, make sure to back up your PC prior to using the auto-start function of this script.

#Before using the auto-start function you'll need to put a shortcut to the plex_discord_rpc.py file 
#in C:\Users\yourusername\AppData\Microsoft\Windows\Start Menu\Programs\Startup\ the actual file can be in any location on your PC.
